...
def getCntkRoiCoordsLine(rect, targetw, targeth, imgFilename):
    ...
    if hrel <= 0.0:
        hrel = 0
    assert xrel <= 1.0, "Error: xractualel should be <= 1 but is " + str(xrel) + str(imgFilename)
    assert yrel <= 1.0, "Error: yrel should be <= 1 but is " + str(yrel) + str(imgFilename)
    assert wrel >= 0.0, "Error: wrel should be >= 0 but is " + str(wrel) + str(imgFilename)
    assert hrel >= 0.0, "Error: hrel should be >= 0 but is " + str(hrel) + str(imgFilename)
