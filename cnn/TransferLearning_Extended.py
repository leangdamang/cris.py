...
train_image_folder = os.path.join(base_folder, "..", "DataSets", "transfer2", "Train")
test_image_folder = os.path.join(base_folder, "..", "DataSets", "transfer2", "Test")
...
if __name__ == '__main__':
    ...
    new_model_file = os.path.join(base_folder, "Output", "TransferLearning2.model")
